...
- Error Function (aka. loss/cost function): absolute & square errors. However, mean absolute errors and mean square errors or root mean square errors (RMSE) are more commonly used in practice because mean errors are easier to compare between models.
